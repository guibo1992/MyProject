...
<body>
  <div class="content-wrapper">
	    ...
	    <div class="box-body">
	      <div id="toolbar" class="form-inline" role="form">
			...
			<div class="form-group margin-l-5">
			  <button class="btn btn-success" id="add"> <i class="fa fa-plus"></i> 添加报告异常</button>
			</div>
	      </div>
	...
	<div class="modal fade" id="anomalyModal" role="dialog" aria-labelledby="anomalyModalLabel" data-backdrop="static">
	  <div class="modal-dialog" role="document">
	    <form id="anomalyForm" class="modal-content form-horizontal">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title" id="anomalyModalLabel">结果解释</h4>
	      </div>
		  <div class="modal-body">
			...
			<div class="row"> 
		      <div class="col-md-12">
                ...
                <div class="form-group">
                  <label for="anomaly" class="control-label col-md-3">异常内容：</label>
                  <div class="col-md-8">
                    <textarea name="anomaly" id="anomaly" rows="6" placeholder="异常内容" class="form-control" maxlength="250" role="data-remain"></textarea>
                  </div>
                </div>
              </div>
	        </div>
...
<imports>
  ...
  <script src="/static/js/viewjs/report-anomaly.js"></script>
</imports>