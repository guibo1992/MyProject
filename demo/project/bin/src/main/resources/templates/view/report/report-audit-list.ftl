	        ...
	        <div class="form-group active-default margin-l-5">
			  <div id="auditStatus" class="btn-group" data-toggle="buttons">
			    <label class="btn btn-default active">
			      <input type="radio" name="auditStatus" value="WAIT_AUDIT" autocomplete="off"> 等待审核
			    </label>
			    <label class="btn btn-default">
			      <input type="radio" name="auditStatus" value="AUDIT_REJECT" autocomplete="off"> 已驳回
			    </label>
			    <label class="btn btn-default">
			      <input type="radio" name="auditStatus" value="AUDIT_PASSED" autocomplete="off"> 已审核
			    </label>
			    <label class="btn btn-default">
			      <input type="radio" name="auditStatus" value="" autocomplete="off"> 全部
			    </label>
			  </div>
			</div>
	      </div>
...
<imports>
  ...
  <script src="/static/js/viewjs/report-audit-list.js"></script>
</imports>