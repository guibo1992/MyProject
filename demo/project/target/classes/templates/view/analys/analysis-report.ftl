	  ...
	  <form id="reportForm" class="box box-success pad">
	      ...
	      <div class="form-group">
        	<div class="row">
              ...
              <div class="col-xs-4">
                ...
                <#if template.inspectionPhysician>
	                <div>
	    ...
	    <div class="box-body">
	      <div class="margin-bottom-none">
	        ...
	        <div class="form-group">
             ...
             -->
             <#if template.resultInterpretation>
		        <div class="form-group margin-bottom-none">
		          <label>结果解释</label>
		          <textarea name="resultInterpretation" rows="3" class="form-control" placeholder="分析结果解释" role="data-remain" maxlength="200"></textarea>
	    ...
	    <div class="box-body">
         ...
         <#if template.hideRemarks>
          <div class="form-group">
	        <label>备注</label>
	        <textarea name="hideRemarks" rows="3" class="form-control" placeholder="报告备注信息" role="data-remain" maxlength="200">${template.defaultRemarks}</textarea>
          </div>
         </#if>
        </div>
